                ...
                {(() => {
                  ...
                  return (
                    <div style={{ marginBottom: "1rem" }}>
                      <span style={{ color: THEME_CONFIG.gold, fontSize: "0.95rem", fontWeight: 600, fontFamily: "'Playfair Display', serif" }}>
                        Starting from &#8377;{min.toLocaleString("en-IN")}
                      </span>
                    </div>
                  );
                })()}
              ...
              <div className="doctor-card-luxury">
                <div className="doctor-img-wrap">
                  {doctor.image ? (
                    ...
                    <div className="doctor-img d-flex align-items-center justify-content-center" style={{ background: 'linear-gradient(135deg, #086351 0%, #0a7d66 100%)', color: '#C9A84C', fontSize: '2.8rem', fontFamily: "'Playfair Display', serif", fontWeight: 700, letterSpacing: 2 }}>
                      {doctor.name.replace('Dr. ', '').split(' ').map((n: string) => n[0]).join('')}
                    </div>
                  )}
